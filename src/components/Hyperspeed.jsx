...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    (function () {
      ...
      const init = () => {
        // wait until container has layout box
        ...
        try {
          console.log('Hyperspeed: Starting initialization...', { w, h, effectOptions });
          const options = { ...effectOptions };
          options.distortion = distortions[options.distortion];
          
          if (!options.distortion) {
            console.error('Hyperspeed: Invalid distortion type:', effectOptions.distortion);
            options.distortion = distortions['turbulentDistortion'];
          }

          console.log('Hyperspeed: Creating App with options:', options);
