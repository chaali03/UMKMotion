  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 768px) { .product-card { margin: 0 0 24px; border-radius: 0; box-shadow: none; } }
        ...
        .thumb:hover { border-color: #10b981; transform: translateY(-2px); }
        ...
        .big-rating { font-size: 52px; font-weight: 800; color: #0f172a; line-height: 1; display: flex; align-items: center; gap: 10px; }
        .big-star { color: #fbbf24; font-size: 40px; }
        .satisfaction { background: linear-gradient(135deg, #ecfdf5, #d1fae5); color: #166534; padding: 8px 14px; border-radius: 10px; font-size: 14px; font-weight: 700; margin: 10px 0; display: inline-block; }

        .progress-row { display: flex; align-items: center; gap: 10px; font-size: 13.5px; opacity: 0; animation: slideIn 0.6s ease forwards; }
        ...
        .rec-card:hover { transform: translateY(-6px); box-shadow: 0 16px 32px rgba(0,0,0,0.12); border-color: #10b981; }
        ...
        .rec-title { font-size: 13.5px; font-weight: 600; color: #0f172a; line-height: 1.45; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
      ...
      <div className="page-container">
        ...
        <div className="product-card">
                  ...
                  {carouselImages.map((src, i) => (
                    <div key={i} className={`carousel-slide ${isZoomed ? "zoomed" : ""}`}>
                      <img
                        ...
                        onError={(e) => (e.currentTarget.src = "https://via.placeholder.com/600x800/f3f4f6/9ca3af?text=No+Image")}
                        style={{
          ...
          {/* TOKO SECTION */}
          <div style={{ margin: '20px auto', maxWidth: '1200px', padding: '0 16px' }}>
            <div style={{
