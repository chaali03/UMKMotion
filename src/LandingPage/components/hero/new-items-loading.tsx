...
function NewItemsLoading() {
  return (
    <>
      <a
        href={item?.href}
        className=" inline-flex justify-center w-fit mx-auto items-center gap-1 rounded-full  bg-[#ff6a00] border-4 dark:border-neutral-800 border-neutral-200  shadow-[#080808]  py-0.5 pl-0.5 pr-3 text-xs "
      >
