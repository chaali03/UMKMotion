...
export default function Konten() {
  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 px-3 sm:px-4 md:px-6 lg:px-8 bg-white" ref={heroRef}>
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-20 sm:-top-40 -right-20 sm:-right-40 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-gradient-to-br from-orange-200/40 to-amber-200/40 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 sm:-bottom-40 -left-20 sm:-left-40 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-gradient-to-tr from-amber-200/40 to-orange-200/40 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 mb-16 sm:mb-20 md:mb-24 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 md:space-y-10 order-2 lg:order-1">
            ...
            >
              <motion.div 
                ...
                className="relative bg-gradient-to-br from-white to-orange-50/50 backdrop-blur-xl border border-orange-200/60 rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-xl shadow-orange-500/10"
                ...
                <div className="relative">
                  <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    <motion.div 
                      ...
                      className="p-1.5 sm:p-2 md:p-2.5 bg-sky-100 rounded-lg sm:rounded-xl"
                    >
              ...
              <motion.div 
                whileHover={{ y: -4 }}
                transition={{ type: "spring", stiffness: 400, damping: 25 }}
                className="relative bg-gradient-to-br from-white to-amber-50/50 backdrop-blur-xl border border-amber-200/60 rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-xl shadow-amber-500/10"
                style={{ transformStyle: "preserve-3d" }}
              >
                <div className="relative">
                  <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                    <motion.div 
                      whileHover={{ scale: 1.15, rotate: -5 }}
                      transition={{ type: "spring", stiffness: 400, damping: 10 }}
                      className="p-1.5 sm:p-2 md:p-2.5 bg-violet-100 rounded-lg sm:rounded-xl"
                    >
            ...
            >
              <motion.button
                ...
                className="relative bg-gradient-to-r from-orange-600 via-amber-600 to-orange-600 text-white px-6 sm:px-8 md:px-10 py-4 sm:py-5 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg shadow-2xl shadow-orange-500/40 flex items-center justify-center gap-2 sm:gap-3 w-full sm:w-auto"
                ...
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <motion.div 
                      ...
                      transition={{ duration: 0.2 }}
                      className="w-8 sm:w-10 h-8 sm:h-10 rounded-full border-2 border-white bg-gradient-to-br from-orange-400 to-amber-400 flex items-center justify-center text-white font-bold text-xs sm:text-sm shadow-lg"
                      style={{ transformStyle: "preserve-3d" }}
                    >
                      {i}K
                    </motion.div>
          ...
          >
            <motion.div 
              ...
              className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/80 to-orange-50/60 p-1.5 sm:p-2 border-2 border-white/60 backdrop-blur-xl"
              style={{ transformStyle: "preserve-3d" }}
            >
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden">
                    ...
                    >
                      <div className="relative">
                        ...
                        <motion.div 
                          ...
                          transition={{ type: "spring", stiffness: 400, damping: 10 }}
                          className="relative w-7 sm:w-8 md:w-10 h-7 sm:h-8 md:h-10 bg-gradient-to-br from-orange-500 to-amber-500 rounded-full flex items-center justify-center border-2 sm:border-3 border-white shadow-lg"
                          style={{ transformStyle: "preserve-3d" }}
                        >
                ...
                >
                  <motion.div 
                    whileHover={{ y: -2 }}
                    transition={{ duration: 0.2 }}
                    className="bg-white/95 backdrop-blur-md rounded-xl sm:rounded-2xl p-2.5 sm:p-3 md:p-4 border border-orange-100 max-w-[140px] sm:max-w-[180px] md:max-w-[200px] shadow-lg"
                    style={{ transformStyle: "preserve-3d" }}
                  >
                    <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                      <motion.div 
                        whileHover={{ scale: 1.15, rotate: 5 }}
                        transition={{ duration: 0.2 }}
                        className="p-1.5 sm:p-2 bg-gradient-to-br from-orange-500 to-amber-500 rounded-md sm:rounded-lg"
                      >
                ...
                >
                  <motion.div 
                    whileHover={{ y: -2 }}
                    transition={{ duration: 0.2 }}
                    className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl sm:rounded-2xl p-2 sm:p-3 md:p-4 border-2 border-white/50 shadow-lg"
                    style={{ transformStyle: "preserve-3d" }}
                  >
                ...
                >
                  <motion.div 
                    whileHover={{ y: -2 }}
                    transition={{ duration: 0.2 }}
                    className="bg-white/95 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 border border-orange-100 shadow-lg"
                    style={{ transformStyle: "preserve-3d" }}
                  >
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4">
                      <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
                        <motion.div 
                          whileHover={{ scale: 1.15, rotate: 5 }}
                          transition={{ duration: 0.2 }}
                          className="p-2 sm:p-2.5 md:p-3 bg-gradient-to-br from-orange-500 to-amber-500 rounded-lg sm:rounded-xl"
                        >
          ...
          {[
            ...
            >
              <motion.div
                whileHover={{ y: -6 }}
                transition={{ type: "spring", stiffness: 400, damping: 25 }}
                className={`relative bg-gradient-to-br ${service.bgGradient} backdrop-blur-xl border border-white/60 rounded-2xl sm:rounded-3xl p-6 sm:p-7 md:p-8 h-full shadow-lg`}
                style={{ transformStyle: "preserve-3d" }}
              >
                <div className="relative space-y-3 sm:space-y-4 md:space-y-5">
                  <motion.div 
                    whileHover={{ scale: 1.15, rotate: 5 }}
                    transition={{ type: "spring", stiffness: 400, damping: 10 }}
                    className={`w-12 sm:w-14 md:w-16 h-12 sm:h-14 md:h-16 bg-gradient-to-br ${service.gradient} rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg mx-auto`}
                    style={{ transformStyle: "preserve-3d" }}
                  >
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-2 sm:mb-3 text-center">
                      {service.title}
                    </h3>
                    <p className="text-slate-600 leading-relaxed text-sm sm:text-base text-center">
                      {service.description}
                    </p>
                  </div>
                  ...
                  <motion.div 
                    whileHover={{ x: 4 }}
                    transition={{ duration: 0.2 }}
                    className="flex items-center gap-2 text-orange-600 font-semibold text-xs sm:text-sm pt-2 justify-center cursor-pointer"
                  >
        ...
        >
          <motion.div
            ...
            transition={{ type: "spring", stiffness: 300, damping: 30 }}
            className="relative bg-gradient-to-r from-orange-600 via-amber-600 to-orange-600 rounded-2xl sm:rounded-3xl md:rounded-[2.5rem] p-6 sm:p-10 md:p-12 lg:p-16 shadow-2xl"
            style={{ transformStyle: "preserve-3d" }}
          >
            {/* Background Pattern */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center md:justify-start gap-4 sm:gap-6 pt-2 sm:pt-4">
                  <div className="flex items-center gap-2 text-white">
                    <motion.div 
                      whileHover={{ scale: 1.15, rotate: 5 }}
                      transition={{ duration: 0.2 }}
                      className="w-10 sm:w-12 h-10 sm:h-12 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center border border-white/30"
                      style={{ transformStyle: "preserve-3d" }}
                    >
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                className="relative bg-white text-slate-900 px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 rounded-xl sm:rounded-2xl font-black text-base sm:text-lg md:text-xl shadow-2xl flex items-center gap-3 sm:gap-4 whitespace-nowrap w-full md:w-auto justify-center"
                onClick={() => window.location.href = "/rumah-umkm"}
                style={{ transformStyle: "preserve-3d" }}
              >
                <motion.div
                ...
                >
                  <Compass className="w-5 sm:w-6 h-5 sm:h-6 text-orange-600" />
                </motion.div>
